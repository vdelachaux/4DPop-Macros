...
If (False:C215)
	C_LONGINT:C283(util_Lon_array_declaration; $0)
	C_TEXT:C284(util_Lon_array_declaration; $1)
	C_POINTER:C301(util_Lon_array_declaration; ${2})
End if 
...
If ($Lon_error=0)
	...
	$Txt_row:=Replace string:C233($Txt_row; " "; "")
	
	Case of 
			
			//______________________________________________________
		: (str_isNumeric($Txt_row))  //numeric declaration
	...
	Case of 
		...
		: (Length:C16($Txt_column)=0)
			...
			//______________________________________________________
		: (str_isNumeric($Txt_column))  //numeric declaration
