			...
			For ($i; 1; $number; 1)
				...
				Case of 
					...
					: (Position:C15($Col_arrays[5]; $t)=1)  // ARRAY LONGINT
						...
						util_Lon_array_declaration($t; ->$tTxt_arrayLONGINT; ->$tTxt_local; ->$Lon_size; ->$Boo_2Darray)
						TRACE:C157
						If ($Ptr_array->>0)
					...
					: (Position:C15($Col_arrays[10]; $t)=1)  //TABLEAU TEXTE
						...
						util_Lon_array_declaration($t; ->$tTxt_arrayTEXT; ->$tTxt_local; ->$Lon_size; ->$Boo_2Darray)
