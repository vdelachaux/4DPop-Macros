		...
		Else 
			...
			Case of 
				...
				: ($1="isStyled")  // Returns True if text is styled
					...
					$Txt_filtered:=Formula from string:C1601("ST Get plain text:C1092($1)").call(Null:C1517; $t)
					$Txt_result:=Formula from string:C1601("ST Get text:C1116($1)").call(Null:C1517; $t)
