...
If ($Obj_macro.process)  // Install menu bar to allow Copy - Paste
	...
	APPEND MENU ITEM:C411($t;Get localized string:C991("CommonMenuItemUndo"))
	...
	APPEND MENU ITEM:C411($t;Get localized string:C991("CommonMenuRedo"))
	...
	APPEND MENU ITEM:C411($t;Get localized string:C991("CommonMenuItemCut"))
	...
	APPEND MENU ITEM:C411($t;Get localized string:C991("CommonMenuItemCopy"))
	...
	APPEND MENU ITEM:C411($t;Get localized string:C991("CommonMenuItemPaste"))
	...
	APPEND MENU ITEM:C411($t;Get localized string:C991("CommonMenuItemClear"))
	SET MENU ITEM PROPERTY:C973($t;-1;Associated standard action:K28:8;ak clear:K76:56)
	
	APPEND MENU ITEM:C411($t;Get localized string:C991("CommonMenuItemSelectAll"))
	...
	APPEND MENU ITEM:C411($t;Get localized string:C991("CommonMenuItemShowClipboard"))
	SET MENU ITEM PROPERTY:C973($t;-1;Associated standard action:K28:8;ak show clipboard:K76:58)
	
	$tt:=Create menu:C408
	APPEND MENU ITEM:C411($tt;Get localized string:C991("CommonMenuEdit");$t)
	RELEASE MENU:C978($t)
	
	SET MENU BAR:C67($tt)
	RELEASE MENU:C978($tt)
