...
_O_C_BOOLEAN:C305($Boo_match)
_O_C_LONGINT:C283($Lon_i; $Lon_parameters; $Lon_size; $Lon_start)
_O_C_TEXT:C284($Txt_errorMethod)
_O_C_OBJECT:C1216($Obj_in; $Obj_out; $Obj_value)
